...
query = {
    ...
    "_source": ["data.id", "data.attributes.mitre_attack_techniques.id", "data.attributes.registry_keys_set"]
}
...
with open("tactic_to_main_registry_correlations.json", "w") as f:
